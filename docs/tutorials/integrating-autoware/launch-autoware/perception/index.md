...
This launch file calls `perception.launch.xml` at [tier4_perception_launch](https://github.com/autowarefoundation/autoware_launch/tree/main/tier4_universe_launch/tier4_perception_launch) package from the `autoware_launch` repository.
...
If you want to customize these arguments,
...
The `perception.launch.xml` launch file is the main perception launch in the `tier4_perception_launch` package.
